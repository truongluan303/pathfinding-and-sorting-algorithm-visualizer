...
class HomeWindow:
    ...
    def __mainloop(self) -> None:
        ...
        if self.__check_mouse_hovered(self._btn1_w, self._btn1_h, mouse):
            self.__draw_button(self._screen, LIGHT_GRAY, self._btn1_w[0], self._btn1_h[0])
        else: 
            self.__draw_button(self._screen, DARK_GRAY, self._btn1_w[0], self._btn1_h[0])

        if self.__check_mouse_hovered(self._btn2_w, self._btn2_h, mouse):
            self.__draw_button(self._screen, LIGHT_GRAY, self._btn2_w[0], self._btn2_h[0])
        else: 
            self.__draw_button(self._screen, DARK_GRAY, self._btn2_w[0], self._btn2_h[0])

        if self.__check_mouse_hovered(self._exit_btn_w, self._exit_btn_h, mouse):
            self.__draw_button(self._screen, LIGHT_GRAY, self._exit_btn_w[0], self._exit_btn_h[0])
        else: 
            self.__draw_button(self._screen, DARK_GRAY, self._exit_btn_w[0], self._exit_btn_h[0])

        # adding the text to the buttons
        self._screen.blit(self._exit_text , (self._exit_btn_w[0] + 150, self._exit_btn_h[0] + 15)) 
    ...
    def __event_handling(self, mouse) -> None:
        ...
        for ev in pygame.event.get(): 
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN: 
                ...
                if self.__check_button_clicked(self._exit_btn_w, self._exit_btn_h, mouse):
                    sys.exit(0)
    ...
    def __init_components(self):
        ...
        self._message = self._small_font.render('Pick the type of visualizer', True, GREEN)
